...
export class AdapterFactory {
   ...
   */
  static registerAdapter(type: PlatformType, adapterClass: AdapterConstructor): void {
  ...
  static initializeDefaultAdapters(): void {
    ...
    this.registerAdapter('n8n', MockPlatformAdapter as AdapterConstructor);
...
export class AdapterManager {
   ...
   */
  async checkAllAdaptersHealth(): Promise<Map<string, HealthStatus | { status: 'unhealthy'; error: string; lastCheck: Date }>> {
