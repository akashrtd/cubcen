...
describe('Configuration System', () => {
  describe('Environment Validation', () => {
    it('should validate required environment variables', async () => {
      ...
      expect(config.getConfig().JWT_SECRET).toBe('test-jwt-secret-key-min-32-chars-long');
    });
    ...
    it('should validate production environment requirements', async () => {
      ...
      process.env.DATABASE_URL = 'file:./test.db';
      process.env.JWT_SECRET = 'your-super-secret-jwt-key-change-in-production-min-32-chars'; // Default value
