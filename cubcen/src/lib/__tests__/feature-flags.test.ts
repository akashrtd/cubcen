import { FeatureFlagService, featureFlags, requireFeature, requireFeatureMiddleware, applyRolloutStage, FEATURE_ROLLOUT_STAGES } from '../feature-flags';
...
describe('requireFeature decorator', () => {
  ...
  it('should throw error when feature is disabled', () => {
    ...
    expect(() => testInstance.kanbanMethod()).toThrow("Feature 'enableKanbanBoard' is not enabled");
  });
