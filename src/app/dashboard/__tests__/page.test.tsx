...
describe('DashboardPage', () => {
  ...
  it('renders dashboard content after loading', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('Welcome back! Here\'s what\'s happening with your AI agents.')).toBeInTheDocument()
    })
  ...
  it('shows alert for failed tasks', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/8 tasks failed in the last hour/)).toBeInTheDocument()
    })
  })
  ...
  it('displays recent tasks section', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('Data Sync - Customer Records')).toBeInTheDocument()
