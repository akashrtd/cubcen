...
describe('Home', () => {
  ...
  it('renders main heading and description', () => {
    ...
    expect(screen.getByText('AI Agent Management Platform')).toBeInTheDocument()
    expect(screen.getByText(/Centralized platform to manage, monitor, and orchestrate/)).toBeInTheDocument()
  })
  ...
  it('renders footer', () => {
    ...
    expect(screen.getByText('© 2024 Cubcen. AI Agent Management Platform.')).toBeInTheDocument()
  })
