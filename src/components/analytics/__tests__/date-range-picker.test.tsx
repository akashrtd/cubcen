...
describe('DatePickerWithRange', () => {
  ...
  it('displays selected date range', () => {
    ...
    render(<DatePickerWithRange date={dateRange} onDateChange={mockOnDateChange} />)
  ...
  it('applies custom className', () => {
    const { container } = render(
      <DatePickerWithRange onDateChange={mockOnDateChange} className="custom-class" />
    )
  ...
  it('handles invalid date ranges gracefully', () => {
    ...
    expect(() => {
      render(<DatePickerWithRange date={invalidDateRange} onDateChange={mockOnDateChange} />)
    }).not.toThrow()
  })
