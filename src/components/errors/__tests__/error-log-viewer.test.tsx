...
describe('ErrorLogViewer', () => {
  ...
  it('should render loading state initially', () => {
    ...
    expect(
      screen.getByText('System error logs and debugging information')
    ).toBeInTheDocument()
  ...
  it('should fetch and display error logs', async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText('Connection timeout occurred')
      ).toBeInTheDocument()
  ...
  it('should handle pagination', async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText('Showing 1 to 25 of 50 entries')
      ).toBeInTheDocument()
  ...
  it('should truncate long error messages in table', async () => {
    const longMessage =
      'This is a very long error message that should be truncated when displayed in the table view to prevent layout issues and improve readability'
