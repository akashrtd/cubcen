...
describe('TaskCard', () => {
  ...
  it('displays correct status icon for pending task', () => {
    ...
    const statusIcon =
      screen.getByTestId('task-status-icon') ||
      document.querySelector('[data-testid*="clock"]')
  ...
  it('handles missing agent gracefully', () => {
    const taskWithMissingAgent = createMockTask({
  ...
  it('truncates long descriptions', () => {
    const longDescTask = createMockTask({
      description:
        'This is a very long description that should be truncated to prevent the card from becoming too tall and affecting the layout',
    })
