 ...
 */
router.get('/', authenticate, requireAdmin, validateQuery(userQuerySchema), async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/:id', authenticate, requireSelfOrAdmin('id'), validateParams(idParamSchema), async (req: Request, res: Response) => {
  try {
    const { id } = req.params
 ...
 */
router.put('/:id/profile', authenticate, requireSelfOrAdmin('id'), validateParams(idParamSchema), validateBody(updateUserProfileSchema), async (req: Request, res: Response) => {
  try {
    const { id } = req.params
 ...
 */
router.put('/:id/status', authenticate, requireAdmin, validateParams(idParamSchema), validateBody(updateUserStatusSchema), async (req: Request, res: Response) => {
  try {
    const { id } = req.params
 ...
 */
router.get('/:id/activity', authenticate, requireSelfOrAdmin('id'), validateParams(idParamSchema), validateQuery(paginationQuerySchema), async (req: Request, res: Response) => {
  try {
    const { id } = req.params
 ...
 */
router.get('/:id/stats', authenticate, requireSelfOrAdmin('id'), validateParams(idParamSchema), async (req: Request, res: Response) => {
  try {
    const { id } = req.params
