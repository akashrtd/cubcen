...
describe('BackupService', () => {
  ...
  describe('createBackup', () => {
    it('should create a backup successfully', async () => {
      ...
      expect(mockFs.mkdir).toHaveBeenCalledWith(testBackupPath, {
        recursive: true,
      })
    })
  ...
  describe('cleanupOldBackups', () => {
    it('should delete backups older than retention period', async () => {
      ...
      // Mock listBackups
      jest
        .spyOn(backupService, 'listBackups')
        .mockResolvedValue(mockBackups as never)

      // Mock deleteBackup
      const deleteBackupSpy = jest
        .spyOn(backupService, 'deleteBackup')
...
describe('ScheduledBackupService', () => {
  ...
  describe('start', () => {
    it('should start scheduled backups', () => {
      ...
      jest.spyOn(backupService, 'cleanupOldBackups').mockResolvedValue(0)
